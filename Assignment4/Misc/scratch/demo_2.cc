...
main (int argc, char *argv[])
{
        ...
        Ptr<OutputStreamWrapper> stream4 = asciiTraceHelper.CreateFileStream ("seventh_rtt.txt");
        ns3TcpSocket->TraceConnectWithoutContext ("RTT", MakeBoundCallback (&RttChange, stream4));

        Ptr<OutputStreamWrapper> stream35 = asciiTraceHelper.CreateFileStream ("seventh-ssthresh.txt");
        ...
        pointToPoint.EnablePcapAll ("seventh-file");

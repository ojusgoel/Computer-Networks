...
main (int argc, char *argv[])
{
        ...
        Ptr<OutputStreamWrapper> stream = asciiTraceHelper.CreateFileStream ("Vegas.cwnd");
        ns3TcpSocket->TraceConnectWithoutContext ("CongestionWindow", MakeBoundCallback (&CwndChange, stream));
        
        Ptr<OutputStreamWrapper> stream4 = asciiTraceHelper.CreateFileStream ("Vegas_rtt.txt");
        ns3TcpSocket->TraceConnectWithoutContext ("RTT", MakeBoundCallback (&RttChange, stream4));

        Ptr<OutputStreamWrapper> stream35 = asciiTraceHelper.CreateFileStream ("Vegas-ssthreshold.txt");

/*tracing congestion window, rtt change, ssthreshold change in tcp*/
...
main (int argc, char *argv[])
{
        ...
        pointToPoint.SetDeviceAttribute ("DataRate", StringValue ("100Mbps"));            //set the data rate and delay here
        ...
        Ptr<OutputStreamWrapper> stream = asciiTraceHelper.CreateFileStream ("Highspeed.cwnd");
        ns3TcpSocket->TraceConnectWithoutContext ("CongestionWindow", MakeBoundCallback (&CwndChange, stream));
        
        Ptr<OutputStreamWrapper> stream4 = asciiTraceHelper.CreateFileStream ("Highspeed_rtt.txt");
        ns3TcpSocket->TraceConnectWithoutContext ("RTT", MakeBoundCallback (&RttChange, stream4));

        Ptr<OutputStreamWrapper> stream35 = asciiTraceHelper.CreateFileStream ("Highspeed-ssthreshold.txt");
        ...
        pointToPoint.EnablePcapAll ("file_5");
